...
exports.BaseContext = exports.State = void 0;
...
var BaseContext = /** @class */ (function (_super) {
    ...
    BaseContext.prototype.sendCommand = function (command) {
        ...
        return new Promise(function (resolve, reject) {
            _this.send(command + "\n", function (err, result) {
                var _a;
                if (err || result.toString().includes("-1") || ((_a = result.value) === null || _a === void 0 ? void 0 : _a.includes("-1"))) {
                    debug(error(err === null || err === void 0 ? void 0 : err.message));
                    _this.end();
                    reject(err);
                }
                else {
